...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _make_dual: "f32[4, 3]" = torch._functorch.predispatch._make_dual(l_x_, _add_batch_dim, level = 0);  l_x_ = _add_batch_dim = None
        ...
        _unwrap_for_grad_1: "f32[4, 3, 4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_4, 2);  getitem_4 = _unwrap_for_grad_1 = None
        _unwrap_for_grad_2: "f32[4, 3, 4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_5, 2);  getitem_5 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _make_dual: "f32[3, 4]" = torch._functorch.predispatch._make_dual(l_y_, _add_batch_dim, level = 0);  l_y_ = _add_batch_dim = None
        ...
        _unwrap_for_grad_1: "f32[4, 3, 3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_4, 2);  getitem_4 = _unwrap_for_grad_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[5]", L_x_: "f32[5]"):
        ...
        _unwrap_for_grad: "f32[5]" = torch._functorch.predispatch._unwrap_for_grad(sin, 1)
        _unwrap_for_grad_1: "f32[5]" = torch._functorch.predispatch._unwrap_for_grad(cos, 1)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[5]"):
        ...
        _unwrap_for_grad: "f32[5]" = torch._functorch.predispatch._unwrap_for_grad(_wrap_for_grad, 1);  _wrap_for_grad = _unwrap_for_grad = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._functorch.predispatch._unwrap_for_grad(sum_1, 1);  _unwrap_for_grad = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad_1: "f32[]" = torch._functorch.predispatch._unwrap_for_grad(sum_1, 1);  _unwrap_for_grad_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._functorch.predispatch._unwrap_for_grad(sum_1, 2);  _unwrap_for_grad = None
        ...
        _unwrap_for_grad_2: "f32[]" = torch._functorch.predispatch._unwrap_for_grad(_unwrap_for_grad_1, 1);  _unwrap_for_grad_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._functorch.predispatch._unwrap_for_grad(add, 1);  _unwrap_for_grad = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _unwrap_for_grad: "f32[4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad = None
        _unwrap_for_grad_1: "f32[4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad = None
        _unwrap_for_grad_1: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad_1: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad_1 = None
        _unwrap_for_grad_2: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad_2: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_3, 2);  getitem_3 = _unwrap_for_grad_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]"):
        ...
        _unwrap_for_grad: "f32[3, 3]" = torch._functorch.predispatch._unwrap_for_grad(_make_dual, 1);  _make_dual = None
